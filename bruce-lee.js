...
var _user$project$Sprite$Frame = F4(
	function (a, b, c, d) {
		return {x: a, y: b, w: c, h: d};
	});

var _user$project$Bruce$sprite = function (frame) {
	return A2(
			...
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					...
					_0: _rtfeldman$elm_css$Css$width(
						_rtfeldman$elm_css$Css$px(frame.w)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$height(
							_rtfeldman$elm_css$Css$px(frame.h)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundImage(
								_rtfeldman$elm_css$Css$url('../images/brucelee-characters.png')),
							_1: {
								ctor: '::',
								_0: A2(
									_rtfeldman$elm_css$Css$backgroundPosition2,
									_rtfeldman$elm_css$Css$px(frame.x),
									_rtfeldman$elm_css$Css$px(frame.y)),
								_1: {
									ctor: '::',
...
var _user$project$Bruce$renderAllFrames = function (frames) {
	var list = A2(_elm_lang$core$List$map, _user$project$Bruce$sprite, frames);
	return A2(
...
var _user$project$BruceLee$update = F2(
	function (msg, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{currentFrame: 0});
	});
var _user$project$BruceLee$initialModel = {
	currentFrame: 0,
	frames: {
		ctor: '::',
		_0: A4(_user$project$Sprite$Frame, -12, -4, 16, 21),
		_1: {
			ctor: '::',
			_0: A4(_user$project$Sprite$Frame, -32, -6, 14, 19),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$BruceLee$view = function (model) {
	return _user$project$Bruce$renderAllFrames(_user$project$BruceLee$initialModel.frames);
};
var _user$project$BruceLee$main = _rtfeldman$elm_css$Html_Styled$beginnerProgram(
	{model: _user$project$BruceLee$initialModel, view: _user$project$BruceLee$view, update: _user$project$BruceLee$update})();
var _user$project$BruceLee$Model = F2(
	function (a, b) {
		return {currentFrame: a, frames: b};
	});
var _user$project$BruceLee$Start = {ctor: 'Start'};

var Elm = {};
Elm['BruceLee'] = Elm['BruceLee'] || {};
if (typeof _user$project$BruceLee$main !== 'undefined') {
    _user$project$BruceLee$main(Elm['BruceLee'], 'BruceLee', undefined);
}
